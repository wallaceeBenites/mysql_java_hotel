...
public class processaMostraTabelaPesquisandoNumeroDeReserva {
	...
	public processaMostraTabelaPesquisandoNumeroDeReserva() {

	}

	public JTable mostraTabelaPesquisada1(String numeroDaReservaPesquisado) throws SQLException {
	...
	public JTable mostraTabelaPesquisada2(String numeroDaReservaPesquisado) throws SQLException {
